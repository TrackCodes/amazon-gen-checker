...
def amazonapp():
    init(convert=True)
    ctypes.windll.kernel32.SetConsoleTitleW("Amazon Gen and Checker")
   ...
   |__/|__/      \_______/ \_______/|__/  \__/
    ...
    if option == '1':
        ...
        for i in range(amount):
            ...
            f.close()
            fix += 1
            ctypes.windll.kernel32.SetConsoleTitleW("Generated Codes: " + str(fix) + "/" + str(amount) + " | MADE BY Track")
        time.sleep(2)
        os.system('cls')
        amazonapp()
        ...
        def checker():
            try:
                ...
                if success_keyword in r.text:
                    ...
                    mkj.write(kll)
                    mkj.close()
                    ctypes.windll.kernel32.SetConsoleTitleW("Amazon Checker | Checked: " + str(num) + "/" + str(len(giftcards)) + " | Valid: " + str(valid) + " | Invalid: " + str(invalid) + " | MADE BY Track")
                else:
